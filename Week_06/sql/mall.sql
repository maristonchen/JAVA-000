...
(
    customer_id bigint(32) auto_increment comment '主键ID' primary key,
...
(
    goods_id bigint(32) auto_increment comment '主键ID' primary key,
...
(
    order_id bigint(32) auto_increment comment '主键ID' primary key,
    customer_id bigint(32) not null comment '客户ID',
    all_amount decimal(10,2) null default 0 comment '订单总金额',
    actual_amount decimal(10,2) null default 0 comment '实际支付金额',
    status tinyint(1) default b'0'  comment '订单状态 0-新建 1-待支付 2-待发货 3-待配送 4-已收货 5-待退货 6-待退款 7-完成交易 8-已退货 ',
...
create or replace table t_order_list
(
    list_id bigint(32) auto_increment comment '主键ID' primary key,
    ...
    status tinyint(1) default b'0'  comment '状态 0-待发货 1-已收货 2-待退货 3-已退货 '
)
comment '订单明细表';
